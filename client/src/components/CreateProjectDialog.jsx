    ...
    <div className="fixed inset-0 bg-black/20 dark:bg-black/60 backdrop-blur flex items-center justify-center text-left z-50">
      <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 w-full max-w-lg text-zinc-900 dark:text-zinc-200 relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="project-status" className="block text-sm mb-1">
                Status
              </label>
              <select
                id="project-status"
            ...
            <div>
              <label htmlFor="project-priority" className="block text-sm mb-1">
                Priority
              </label>
              <select
                id="project-priority"
          ...
          {/* Project Lead */}
          <div>
            <label htmlFor="team-lead" className="block text-sm mb-1">
              Project Lead
            </label>
            <select
              id="team-lead"
              ...
              onChange={(e) => {
                ...
                setFormData((prev) => ({
                  ...
                  team_lead: value,
                  team_members: value
                    ? [...new Set([...prev.team_members, value])]
                    : prev.team_members,
                }));
              }}
              className="w-full px-3 py-2 rounded dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 text-sm"
          ...
          {/* Team Members */}
          <div>
            <label htmlFor="team-members" className="block text-sm mb-1">
              Team Members
            </label>
            <select
              id="team-members"
              ...
              onChange={(e) => {
                ...
                if (value && !formData.team_members.includes(value)) {
                  setFormData((prev) => ({
                    ...prev,
                    team_members: [...prev.team_members, value],
                  }));
                }
              }}
            >
